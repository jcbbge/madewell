...
2026-08-20 | Locked-spec Commit starts Build at Plan; Imagine is the sitting that bounded the item | Arc laboratory: transcript→pipeline is Discovery (pool only); promote is Commit; ORCH does not re-ideate; coder Makes; a different agent Verifies; green on main is Land. Product forks return to the pool. Codified in LIFECYCLE.md + commit.md.
